...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,352111144,1351515656}
print("\27[34m"..[[
...
local UserName = (data.username_ or "XXXXB")
...
local res = https.request('https://tshake.ga/tumblr X-Source.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
...
local UserName = (b.username_ or "XXXXB")
...
os.execute('rm -rf tumblr X-Source.lua')
os.execute('rm -rf start.lua')
download_to_file('https://raw.githubusercontent.com/tumblr X-Source/tumblr X-Source/master/tumblr X-Source.lua', 'tumblr X-Source.lua') 
download_to_file('https://raw.githubusercontent.com/tumblr X-Source/tumblr X-Source/master/start.lua', 'start.lua') 
dofile('tumblr X-Source.lua')  
return false
end
...
[«🥇|𝖳𝖾𝗆𝖻𝗅𝗋 𝖲𝗈𝗎𝗋𝖼𝖾.⚙️.](https://t.me/XXXXB)
